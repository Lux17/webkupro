    ...
    <header class="wt-topbar">
        <div class="wt-topbar-inner">
            <div class="wt-top-left">
                <a href="{{ $materi ? route('lessons', $materi->id_materi) : route('info') }}"
                   class="wt-icon-btn" title="Kembali ke materi">
                    <i class="fas fa-arrow-left"></i>
                </a>
                <div class="wt-title-wrap">
                    <p class="wt-kicker">{{ $materi->title ?? 'Materi' }}</p>
                    <h1 class="wt-title">Ep. {{ $episode->type }} · {{ $episode->nama_eps }}</h1>
                </div>
            </div>
            <div class="wt-top-right">
                @if($materi)
                    <a href="{{ route('lessons', $materi->id_materi) }}" class="wt-icon-btn" title="Daftar episode">
                        <i class="fas fa-list-ul"></i>
                    </a>
                @else
                    <a href="{{ route('info') }}" class="wt-icon-btn" title="Dashboard">
