          ...
          <div class="row mb-3">
            <div class="col-lg-3 col-md-6">
              <div class="ms-stat stat-blue">
                ...
                <div class="value">{{ $hitung_admin }}</div>
              </div>
            </div>
          </div>
            ...
            <div class="ms-toolbar mx-2">
              ...
              <form class="ms-search" method="get" action="{{ route('search_admin') }}">
                <input class="form-control" type="text" name="search" placeholder="Cari nama admin..." aria-label="Search">
