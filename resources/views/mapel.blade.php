            ...
            <div class="row mb-3">
                <div class="col-lg-3 col-md-6">
                  <div class="ms-stat stat-orange">
                    ...
                    <div class="value">{{ $hitung_mapel }}</div>
                  </div>
                </div>
            </div>

            <div class="ms-toolbar mx-2">
              <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#Tambahmapel">
                  <i class="fas fa-plus me-1"></i> Tambah Data
              </button>
              <form class="ms-search" method="get" action="{{ route('search_mapel') }}">
                <input class="form-control" type="text" name="search" placeholder="Cari nama mata pelajaran..." aria-label="Search">
