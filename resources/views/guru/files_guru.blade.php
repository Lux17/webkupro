  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="container z-1">
          ...
          <h1>Data files guru</h1>
          <nav>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="{{ route('dashboard_guru') }}">Guru</a></li>
              <li class="breadcrumb-item active">files guru</li>
            </ol>
          </nav>
        </div>
          ...
          <div class="row mb-3">
            <div class="col-lg-3 col-md-6">
              <div class="ms-stat stat-green">
                <div class="icon-wrap"><i class="far fa-folder-open"></i></div>
                <div class="label">Jumlah File</div>
                <div class="value">{{ $hitung_files }}</div>
              </div>
            </div>
          </div>

            <div class="ms-toolbar mx-2">
              <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#Tambahfiles">
                  <i class="fas fa-plus me-1"></i> Tambah Data
              </button>
              <form class="ms-search" method="get" action="{{ route('search_files') }}">
                <input class="form-control" type="text" name="search" placeholder="Cari nama file..." aria-label="Search">
