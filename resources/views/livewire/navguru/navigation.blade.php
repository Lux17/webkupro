...
<nav class="header-nav ms-auto" style="margin-right:15px; ">
  ...
  <div class="d-flex align-items-center justify-content-between mx-3 my-3">
      <a href="{{ route('dashboard_guru') }}" class="logo d-flex align-items-center text-decoration-none gap-2">
        <img src="{{ asset('assets/images/icon-stem2.png') }}" alt="logo" style="width:34px;height:34px;">
        <span class="text-white fw-bold">MendungSTEM</span>
      </a>
  </div>
    ...
    <div class="sidebar" style="color:white;">
      ...
      <nav class="mt-2">
        ...
        <li class="nav-item has-treeview mb-2">
            <a class="nav-link {{ Route::currentRouteName() == 'dashboard_guru' ? 'active' : 'collapsed'}}" href="{{ route('dashboard_guru') }} ">
